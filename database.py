# -*- coding: utf-8 -*-
"""
Created on Sun Mar 14 12:19:18 2021
...
def main_loop():
    ...
    while True:
        ...
        if choice == 'q':
            ...
            which = input("Which item do you want to delete? (enter serail number)")
            print("which is ", which)
            delete_phone(which)
        elif choice == 's':
            show_phones()
        elif choice == 'e':
            which = input("Which item do you want to edit? (enter serail number)")
            print("which is ", which)
            edit_phone(which)
        else:
